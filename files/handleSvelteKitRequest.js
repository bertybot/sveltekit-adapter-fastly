...
function setUpSveltekitRequestHandler() {
  ...
  return (event) =>
    handleRequest(event, staticContentServer, server, immutable, version_file);
}

/**
 * @param {FetchEvent} event
 * @param {import('@fastly/compute-js-static-publish').PublisherServer} staticContentServer
 * @param {Server} server
...
export const handleSvelteKitRequest = setUpSveltekitRequestHandler();
